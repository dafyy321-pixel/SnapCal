    ...
    <div className="min-h-screen bg-background pb-24">
      <div className="max-w-md mx-auto">
        ...
        <div className="p-6 space-y-5">
          ...
          <Card className="p-5 flex gap-3"><Database className="w-6 h-6 text-primary shrink-0" /><div><h3 className="font-semibold">本地数据</h3><p className="text-sm text-muted-foreground mt-1">使用 SQLite 保存餐食和资料，不需要 Supabase 或用户账号。</p></div></Card>
